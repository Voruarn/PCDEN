...
from datasets.CFFDDataset import CFFDDataset
...
def get_argparser():
    ...
    parser.add_argument("--dataset", type=str, default='CFFD', help='Name of dataset')
...
def get_dataset(opts):
    ...
    train_dst = CFFDDataset(is_train=True,voc_dir=opts.trainset_path, 
                                transform=train_transform)
    val_dst = CFFDDataset(is_train=False,voc_dir=opts.testset_path,
