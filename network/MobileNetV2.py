...
x.shape: torch.Size([2, 16, 256, 256])
x.shape: torch.Size([2, 24, 128, 128])
x.shape: torch.Size([2, 32, 64, 64])
x.shape: torch.Size([2, 96, 32, 32])
x.shape: torch.Size([2, 320, 16, 16])
